                  ...
                  <div class="x_panel">
                    <div class="x_content">
                      ...
                      <table id="datatable-buttons" class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <?php 
                            $perintah = mysqli_query($koneksi3, "SELECT * FROM job a,material_stock b,work_order c WHERE a.material=b.id_matstock AND a.wo=c.id_wo");
                            $no=1;
