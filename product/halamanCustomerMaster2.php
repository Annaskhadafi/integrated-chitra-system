                ...
                <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <form  class="form-inline" role="form" action="tambahDataMaster.php" method="post">
                        <input class="form-control" type = "hidden" name ="item" value="customer2">
                        <input class="form-control" type = "text" name = "customer" placeholder="Customer name">
                        <br>
                        <br>
                ...
                <div class="x_content">
                      <div class="col-md-12 col-sm-12 col-xs-12"> 
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <?php 
                            $perintah = mysqli_query($koneksi2,"SELECT * from customer_master");
                            $no=1;
                            while ($data = mysqli_fetch_array($perintah)) { ?>
                            <tr>
                              <td><?php echo $data['customer'];?></td>
                              <td style="width:70px"><a href="#" class="editinvent" data-idcustomer="<?php echo $data['id_customer_master']; ?>"data-item="customer">Edit</a>
                            </td>
                            </tr><?php $no++; } ?>
                          </tbody>
                        </table>
