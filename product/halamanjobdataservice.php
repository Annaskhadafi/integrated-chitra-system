              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $perintah = mysqli_query($sambung, "SELECT * FROM job a,work_order b,material_stock c,user d where a.wo=b.id_wo and a.material=c.id_matstock and a.person=d.id_user");
                        $no=1;
                        while ($data = mysqli_fetch_array($perintah)) { ?>
                            <tr>
                              <td><?php $idjob=$data['id_job'];echo $idjob;?> </td>
